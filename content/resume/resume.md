...
Développement d'une application Django pour l'administration des aptients, examens et opérateurs de l'application Androïd. La synchronisation avec l'app est réalisée avec un webservice REST en Go.
